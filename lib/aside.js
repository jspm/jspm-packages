...
function Aside(param1) {
    var license = param1.license, name1 = param1.name, version = param1.version, exports = param1.exports, downloads = param1.downloads, updated = param1.updated, type = param1.type, types = param1.types, features = param1.features, created = param1.created, links = param1.links, maintainers = param1.maintainers;
    ...
    })), /*#__PURE__*/ h("div", null, /*#__PURE__*/ h("h3", null, "License"), /*#__PURE__*/ h("jspm-license", null, license), /*#__PURE__*/ h(Seperator, null)), /*#__PURE__*/ h("jspm-links", null, /*#__PURE__*/ h("h3", null, "Links"), Object.entries(links).map(function(param) {
        var _param = _slicedToArray(param, 2), text = _param[0], link = _param[1];
        return link && /*#__PURE__*/ h("jspm-link", null, /*#__PURE__*/ h("h5", null, text), /*#__PURE__*/ h("a", {
            href: link
        }, link));
    })), /*#__PURE__*/ h("jspm-maintainers", null, /*#__PURE__*/ h("h3", null, "Collaborators"), maintainers.map(function(param) {
        var name = param.name, email = param.email;
        /*#__PURE__*/ return h("jspm-maintainer", null, /*#__PURE__*/ h("figure", null, /*#__PURE__*/ h("img", {
